...
exports.output = exports.error = void 0;
const type_1 = require("./type");
const array_1 = require("./array");
const Class = type_1.type('java.lang.Class');
...
exports.error = error;
function output(object, condense) {
    if (condense === true) {
        if (object === circular) {
            return '...';
        }
        ...
        switch (toString.call(object)) {
            case '[object Array]':
                return `[ ${[...object]
                    .map((value) => output(object === value ? circular : value, true))
                    .join(', ')} ]`;
            case '[object Object]':
                return `{ ${[
            ...
            default:
                const list = array_1.array(object);
                if (list) {
                    return output(list);
                }
                else {
